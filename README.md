...
```yaml
image: lowsabishi/transmission-next-vibemod:v1.15.0-baka9
```

如果从 Docker Hub 拉取受限，可以把镜像地址换成 GHCR：

```yaml
image: ghcr.io/cainiao524/transmission-next-vibemod:v1.15.0-baka9
```
